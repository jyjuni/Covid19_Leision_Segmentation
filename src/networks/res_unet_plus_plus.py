...
class ResUnetPlusPlus(nn.Module):
    def __init__(self, name, in_channels, out_channels, filters=[32, 64, 128, 256, 512]):
        ...
        self.output_layer = nn.Sequential(nn.Conv2d(filters[0], out_channels, 1), nn.Sigmoid())
